...
ifdef::env-antora[link:./wrapper-manager-env-options/[wrapper-manager module options].]
ifndef::env-antora[{docs-site}/wrapper-manager-env-options[wrapper-manager documentation site].]
...
ifdef::env-antora[link:./wrapper-manager-nixos-module/[NixOS module integration options].]
ifndef::env-antora[{docs-site}/wrapper-manager-nixos-module/[documentation site].]

* For home-manager, you can view it in
ifdef::env-antora[link:./wrapper-manager-home-manager-module/[home-manager module integration options].]
ifndef::env-antora[{docs-site}/wrapper-manager-home-manager-module/[documentation site].]
...
ifdef::env-antora[github:{github-full}[test directory, rev=main, path=tests]]
ifndef::env-antora[link:./tests[`./tests`]]
...
* For non-flake users, you can do the same with `nix-build tests/ -A results.lib` or `nix build -f tests/ results.lib`.

There is also a test suite for different types of wrapper-manager configurations at
ifdef::env-antora[github:{github-full}[test directory, rev=main, path=tests/configs]]
ifndef::env-antora[link:./tests/configs[`./tests/configs`]]
from the source code.
You can check them the same way as before (e.g., it's the same for flake-using contributors, `nix-build tests/ -A results.configs` for non-flake-using contributors).
...
This project also has a website set up with https://antora.org[Antora].
The files that you need to see are in
ifdef::env-antora[github:{github-full}[`docs/website`, rev=main, path=docs/website]]
ifndef::env-antora[link:./docs/website[`./docs/website`]]
directory.
...
Just see
ifdef::env-antora[github:{github-full}[license file, rev=main, path=LICENSE]]
ifndef::env-antora[link:./LICENSE[`./LICENSE`]]
...
ifdef::env-antora[github:{github-full}[license file, rev=main, path=docs/LICENSE]]
ifndef::env-antora[link:./docs/LICENSE[`./docs/LICENSE`]]
for more info.
